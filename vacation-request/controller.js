...
widgetsView.controller('WidgetsViewController', ['$scope', 'messageHub', function ($scope, messageHub) {
    ...
    $scope.requestVacation = function (vacation) {
        const options = {
            "DateStart": new Date(vacation.DateStart).getTime(),
            "DateEnd": new Date(vacation.DateEnd).getTime(),
        ...
        fetch('/services/ts/vacation-tool/gen/edm/api/Vacations/VacationsService.ts', {
            ...
            console.log("Vacation requested:", data);
            $scope.fetchData();
            $scope.$apply();
        }).catch(error => {
        ...
        console.log("Requested vacation for person ID: " + vacation.Person);
    }
